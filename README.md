...
**AIエージェント向けナビゲーション**: [docs/AGENT_IRMINSUL_NAV.md](docs/AGENT_IRMINSUL_NAV.md) を最初にお読みください。リポジトリ全体のIrminsul構造マップ・推奨読書順序・境界条件が整理されています。
...
AIエージェント向けの完全なリポジトリ地図・読書順序・境界条件は [docs/AGENT_IRMINSUL_NAV.md](docs/AGENT_IRMINSUL_NAV.md) に集約されています。
